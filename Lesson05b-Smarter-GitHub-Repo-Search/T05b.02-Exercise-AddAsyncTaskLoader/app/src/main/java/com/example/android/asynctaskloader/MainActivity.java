...
//        new GithubQueryTask().execute(githubSearchUrl);
        ...
        android.support.v4.content.Loader<String> gitHubLoader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
            ...
            public String loadInBackground() {
               ...
               if(searchUrlString == null || searchUrlString.isEmpty()){
                ...
                try {
                   ...
                   URL gitUrl = new URL(searchUrlString);
                    return   NetworkUtils.getResponseFromHttpUrl(gitUrl);
                } catch (IOException e) {
                    e.printStackTrace();
                    return null;
                }
